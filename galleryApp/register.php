    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (
            ...
            if ($daoGaleria->obtenerTlfGaleria($telefono)) {
                ...
                $to = $email;
                $subject = 'Bienvenido a la app GalleryApp';
                $message = "Bienvenido $nombre_encargado,
                
                this is your password: $password
                Para cualquier duda, contacta con galleryapp@galleryapp.es";
                $headers = "From: galleryapp@galleryapp.es\r\n";
